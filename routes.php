...
$router->get('/changepass', base_path('controllers/user/views/changePass.php'))->only('user');
$router->post('/changepass', base_path('controllers/user/changePass.php'))->only('user');
